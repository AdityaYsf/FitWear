      ...
      <section id="kategori" className="bg-slate-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <article className="overflow-hidden rounded-[1.75rem] bg-white shadow-lg shadow-slate-900/5">
              <img
      ...
      <section id="fitur" className="bg-slate-900 py-16 sm:py-20 text-white">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="rounded-[1.75rem] bg-slate-800/95 p-8 shadow-2xl shadow-slate-950/20 animate-fade-up animate-stagger-2 animate-fade-up animate-stagger-2">
